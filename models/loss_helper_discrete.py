...
def get_loss(end_points, config):
    ...
    # Vote loss
    vote_cls_loss = compute_vote_loss(end_points)
    ...
    loss = end_points['vote_cls_loss_weight']*vote_cls_loss + 0.5*objectness_loss + box_loss + 0.1*sem_cls_loss
    loss *= 10
