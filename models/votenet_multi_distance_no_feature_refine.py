...
from voting_module import VotingModuleMultiDistance_no_feature_refine
...
class VoteNetMultiDistance_no_feature_refine(nn.Module):
    r"""
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
        ...
        # Hough voting
        self.vgen = VotingModuleMultiDistance_no_feature_refine(self.vote_config, 256)
