...
class Pointnet2BackboneDeep(nn.Module):
    r"""
    ...
    def forward(self, pointcloud: torch.cuda.FloatTensor, end_points=None):
        ...
        features = self.fp0(end_points['sa4_xyz'], end_points['sa5_xyz'], end_points['sa4_features'], end_points['sa5_features'])
...
if __name__=='__main__':
    backbone_net = Pointnet2BackboneDeep(input_feature_dim=3).cuda()
    print(backbone_net)
    backbone_net.eval()
