...
from voting_module import VotingModuleDiscrete
from model_util_vote import VoteConfig_Discrete_Grid, VoteConfig_Discrete_Polar
from proposal_module import ProposalModuleMulti
from dump_helper_multi import dump_results
from loss_helper_discrete import get_loss


class VoteNetDiscrete(nn.Module):
    r"""
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
                 input_feature_dim=0, num_proposal=128, vote_config=VoteConfig_Discrete_Grid(), 
                 sampling='vote_fps'):
        super().__init__()
        ...
        # Hough voting
        self.vgen = VotingModuleDiscrete(self.vote_config, 256)
...
if __name__=='__main__':
    ...
    # Define model
    model_multi = VoteNetDiscrete(10,12,10,np.random.random((10,3)), num_proposal=256*3).cuda()
