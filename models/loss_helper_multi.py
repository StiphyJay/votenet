...
def compute_vote_loss(end_points):
    ...
    vote_xyz = end_points['vote_xyz_train'] # B, num_seed*num_vote, 3
    ...
    return vote_loss, vote_cls_loss
...
def get_loss(end_points, config):
    ...
    # Vote loss
    vote_loss, vote_cls_loss = compute_vote_loss(end_points)
    end_points['vote_loss'] = vote_loss
    end_points['vote_cls_loss'] = vote_cls_loss
    ...
    # Final loss function # TODO: adjust the weight
    loss = vote_loss + end_points['vote_cls_loss_weight']*vote_cls_loss + 0.5*objectness_loss + box_loss + 0.1*sem_cls_loss
    loss *= 10
