...
from voting_module import VotingModuleVar
from proposal_module import ProposalModule
from dump_helper import dump_results
from loss_helper_var import get_loss


class VoteNetVar(nn.Module):
    r"""
    ...
    def __init__(self, num_class, num_heading_bin, num_size_cluster, mean_size_arr,
        ...
        # Hough voting
        self.vgen = VotingModuleVar(self.vote_factor, 256)
    ...
    def forward(self, inputs):
        ...
        xyz, var, features = self.vgen(xyz, features)
        features_norm = torch.norm(features, p=2, dim=1)
        features = features.div(features_norm.unsqueeze(1))
        end_points['vote_xyz'] = xyz
        end_points['vote_var'] = var
...
if __name__=='__main__':
    ...
    # Define model
    model = VoteNetVar(10,12,10,np.random.random((10,3))).cuda()
