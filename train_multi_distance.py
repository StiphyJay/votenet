...
if FLAGS.dataset == 'sunrgbd':
    ...
    TRAIN_DATASET = SunrgbdDetectionVotesDatasetMultiDistance('train', num_points=NUM_POINT,
        augment=True,
        use_color=FLAGS.use_color, use_height=(not FLAGS.no_height),
        use_v1=(not FLAGS.use_sunrgbd_v2),
        vote_config=VC)
    TEST_DATASET = SunrgbdDetectionVotesDatasetMultiDistance('val', num_points=NUM_POINT,
        augment=False,
        use_color=FLAGS.use_color, use_height=(not FLAGS.no_height),
        use_v1=(not FLAGS.use_sunrgbd_v2),
        vote_config=VC)
    ...
    TRAIN_DATASET = ScannetDetectionDatasetMultiDistance('train', num_points=NUM_POINT,
        augment=True,
        use_color=FLAGS.use_color, use_height=(not FLAGS.no_height),
        vote_config=VC)
    TEST_DATASET = ScannetDetectionDatasetMultiDistance('val', num_points=NUM_POINT,
        augment=False,
        use_color=FLAGS.use_color, use_height=(not FLAGS.no_height),
        vote_config=VC)
else:
